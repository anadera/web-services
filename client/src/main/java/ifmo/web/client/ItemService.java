 ...
 * 
 */
@WebServiceClient(name = "ItemService", targetNamespace = "http://lab1.web.ifmo/", wsdlLocation = "http://localhost:8080/ItemService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ITEMSERVICE_QNAME = new QName("http://lab1.web.ifmo/", "ItemService");
    ...
    public ItemWebService getItemWebServicePort() {
        return super.getPort(new QName("http://lab1.web.ifmo/", "ItemWebServicePort"), ItemWebService.class);
    }
    ...
    public ItemWebService getItemWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lab1.web.ifmo/", "ItemWebServicePort"), ItemWebService.class, features);
    }
